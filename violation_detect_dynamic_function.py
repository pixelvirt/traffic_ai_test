...
def lane_violation_detection(detection, idx):
    global mid_line_coordinates, red_line_coordinates, red_light, escape_frame, frame_count
    global prev_detections, temp_prev_detections, violation_info, violated_object_ids, violation_frame, violation_allowed_limit
...
try:
    ...
    while True:
        ...
        for idx, detection in enumerate(detections):
            trackings = lane_violation_detection()
